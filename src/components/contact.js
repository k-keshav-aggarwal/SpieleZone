...
const contactus = () => {
    return (
        <div>
            ...
            <li><a href="mailto:satvikgupta_it.aec@yahoo.com" title="Reach Satvik Gupta via email">Satviky</a></li>
            <h2>Discord</h2>
            <li>
            ...
            <h3>DevNote:</h3>
            <li>We accept New game request through Emails and discord</li>
        </div>
    )
}   
