        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { title: "Snake Game", description: "A classic arcade experience (Coming Soon!)." },
              { title: "Hangman", description: "Test your vocabulary with this guessing game." },
            ].map((game, i) => (
              <div key={i} className="bg-[#1e293b] rounded-xl p-6 shadow-md hover:shadow-blue-500/30 transition group">
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-blue-400">{game.title}</h3>
